<?php
  function getUserInfo() {
    ...
    $sql = "SELECT balance FROM json_hijacking.user WHERE username='$usernameByCookies' and password='$passwordByCookies'";
    ...
    return [$usernameByCookies, $passwordByCookies, mysqli_fetch_assoc($result)["balance"]];
  }
?>